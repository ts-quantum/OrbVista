...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.actionLoad_gpaw_band_cube = QAction(MainWindow)
        self.actionLoad_gpaw_band_cube.setObjectName(u"actionLoad_gpaw_band_cube")
        self.actionLoad_gpaw_dens_cube = QAction(MainWindow)
        self.actionLoad_gpaw_dens_cube.setObjectName(u"actionLoad_gpaw_dens_cube")
        self.actionLoad_gpaw_esp_cube = QAction(MainWindow)
        self.actionLoad_gpaw_esp_cube.setObjectName(u"actionLoad_gpaw_esp_cube")
        self.action_draw_band_cube = QAction(MainWindow)
        self.action_draw_band_cube.setObjectName(u"action_draw_band_cube")
        self.action_draw_esp_cube_gpaw = QAction(MainWindow)
        self.action_draw_esp_cube_gpaw.setObjectName(u"action_draw_esp_cube_gpaw")
...
"")
        ...
        self.menuApp.addAction(self.actionLoad_gpaw_band_cube)
        self.menuApp.addAction(self.actionLoad_gpaw_dens_cube)
        self.menuApp.addAction(self.actionLoad_gpaw_esp_cube)
        self.menuApp.addSeparator()
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.action_draw_mo_cube.setText(QCoreApplication.translate("MainWindow", u"MO/Dens/Band cube", None))
        self.action_draw_mo_cube.setIconText(QCoreApplication.translate("MainWindow", u"MO/Dens/Band cube", None))
        ...
        self.actionLoad_gpaw_band_cube.setText(QCoreApplication.translate("MainWindow", u"Load band cube (gpaw)", None))
        self.actionLoad_gpaw_dens_cube.setText(QCoreApplication.translate("MainWindow", u"Load dens cube (gpaw)", None))
        self.actionLoad_gpaw_esp_cube.setText(QCoreApplication.translate("MainWindow", u"Load esp cube (gpaw)", None))
        self.action_draw_band_cube.setText(QCoreApplication.translate("MainWindow", u"band cube (gpaw)", None))
        self.action_draw_esp_cube_gpaw.setText(QCoreApplication.translate("MainWindow", u"esp/dens cube (gpaw)", None))
        ...
        self.abort.setText(QCoreApplication.translate("MainWindow", u"abort", None))
