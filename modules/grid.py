...
class Ui_Grid_settings(object):
    ...
    def retranslateUi(self, Grid_settings):
        ...
        self.label_5.setText(QCoreApplication.translate("Grid_settings", u"iso value Orb/Dens", None))
        self.label_6.setText(QCoreApplication.translate("Grid_settings", u"iso value ESP ", None))
